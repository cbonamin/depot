...
Product.create!(title: 'Rails, Angular, Postgres, and Bootstrap',
  description:
    %{<p>
      ...
      Bootstrap, building an interactive user inter# This file should contain all the record creation needed to seed the database with its default values.
